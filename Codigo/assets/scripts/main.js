    ...
    [
        {
            ...
            "user": "casacaminho",
            "logo": "assets/images/inst-profile/inst_1.png",
            "senha": "1234567",
            "categoria": 6,
        ...
        },
        {
            ...
            "user": "salvação_army",
            "logo": "assets/images/inst-profile/inst_2.png",
            "senha": "12345678",
            "categoria": 0,
        ...
        },
        {
            ...
            "logo": "assets/images/inst-profile/inst_3.jpg",
            "senha": "12345678",
            "categoria": 0,
        ...
        },
        {
            "nome": "Fundação Sara",
            "user": "fundacao_sara",
            "logo": "assets/images/inst-profile/inst_4.jpg",
            "senha": "12345678",
            "categoria": 1,
        ...
        },
        {
            ...
            "user": "SantaBernadete",
            "logo": "assets/images/inst-profile/inst_5.jpg",
            "senha": "123456778",
            "categoria": 3,
        ...
        },
        {
            "nome": "Exército de Salvação",
            "user": "salvação_army",
            "logo": "assets/images/inst-profile/inst_6.jpg",
            "senha": "12345678",
            "categoria": 4,
            "endereco": "R. Maravilhas, 25 - Providência, Belo Horizonte - MG, 31814-040R. Padre Rolim, 222 - Santa Efigênia, Belo Horizonte - MG, 30130-090",
            "telefone": "(31) 3433-3563",
        ...
        },
        {
            ...
            "user": "velha_lar",
            "logo": "assets/images/inst-profile/inst_7.jpg",
            "senha": "12345678",
            "categoria": 5,
        ...
        },
        {
            ...
            "user": "apae_bahia",
            "logo": "assets/images/inst-profile/inst_8.jpg",
            "senha": "1234567",
            "categoria": 6,
        ...
        },
        {
            ...
            "user": "doce_lar",
            "logo": "assets/images/inst-profile/inst_9.jpg",
            "senha": "1234562278",
            "categoria": 5,
...
var db_fakeImgs = 
{
    ...
    [
        {
            "href": "assets/images/img-car/car_1.jpg",
            "alt": "Criança carente",
        },
        {
            "href": "assets/images/img-car/car_2.jpg",
            "alt": "Mão estendida",
        },
        {
            "href": "assets/images/img-car/car_3.png",
            "alt": "Mantimentos",
        },
    ]
};
...
var db_fakeNews = 
{
    ...
    [
        ...
        [
            {
                "href": "assets/images/news/new_3.jpg",
                "titulo": "I hear that Nancy is very pretty.",
                "data": "2021-11-29T13:15:55-03:00",
...
{
    if(localStorage.getItem("instituicoes") == null) localStorage.setItem("instituicoes", JSON.stringify(db_fakeInstituicoes.instituicoes));
    if(localStorage.getItem("img_carrossel") == null) localStorage.setItem("img_carrossel", JSON.stringify(db_fakeImgs.img_carrossel));
    if(localStorage.getItem("inst_news") == null) localStorage.setItem("inst_news", JSON.stringify(db_fakeNews.inst_news));
    ...
    news = JSON.parse(localStorage.getItem("inst_news"));
}
